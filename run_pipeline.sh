...
mkdirs ~/IW/Crops/$exp_name/empty ~/IW/Crops/$exp_name/leopard ~/IW/Crops/$exp_name/lion ~/IW/Crops/$exp_name/buffalo ~/IW/Crops/$exp_name/elephant ~/IW/Crops/$exp_name/waterbuck ~/IW/Crops/$exp_name/hyenaspotted
